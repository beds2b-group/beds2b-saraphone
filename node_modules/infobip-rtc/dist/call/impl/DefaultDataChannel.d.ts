...
type ErrorEventHandler = (errorCode: unknown) => void;
export declare class DefaultDataChannel implements DataChannel {
    ...
    constructor(gateway: InfobipGateway, logger: Logger, callId: string, currentUserIdentity: string, participantResolver: (identity: string) => Participant, iceCandidateHandler: IceCandidateHandler, canSendMessage: () => boolean, emitErrorEvent: ErrorEventHandler, conferenceId: string);
