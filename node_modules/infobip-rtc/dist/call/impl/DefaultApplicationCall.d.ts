...
export declare abstract class DefaultApplicationCall implements ApplicationCall {
    ...
    protected setLocalVideoStream(videoStream: MediaStream): Promise<void>;
    ...
    protected getLocalMediaStream(audio: boolean, video: boolean, cameraOrientation?: CameraOrientation, cameraVideoFrameRate?: number): Promise<MediaStream>;
